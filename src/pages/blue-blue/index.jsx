        ...
        <div className="max-w-5xl mx-auto flex gap-6 items-start">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* 목차가 있는 경우 */}
              {tabContents[activeTab].tableOfContents && (
                <div className="mt-8">
                  <h3 className="text-lg font-bold text-gray-800 mb-4">목차</h3>
                  <ol className="list-decimal list-outside space-y-2 text-gray-600 pl-6 bg-gray-50 py-4 pr-4 rounded-lg">
                    {tabContents[activeTab].tableOfContents.map((item, index) => (
